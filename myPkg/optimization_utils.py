...
import numpy as np
from myPkg.hamiltonian_builder import construct_TD_TAHam, construct_TD_SAHam
from myPkg.fidelity_calculator import compute_state_fidelity, \
...
class OptimizationMonitor:
    ...
    def plot_convergence(self, figsize=(12, 8), save_path=None):
        ...
        """
        from myPkg.plotting_helpers import plot_optimization_convergence
